...
class TrainingMemoryEstimator:
    def __init__(
        ...
        self.optimizer_step_peak_buffer_mb = optimizer_step_peak_buffer_mb
    ...
    def estimate_backward_temp_memory_mb(self, model_name, dtype="fp32"):
        parameter_memory_mb = self.optimizer_estimator.estimate_parameter_memory_mb(
            model_name=model_name,
            dtype=dtype,
        )

        return parameter_memory_mb * self.backward_temp_factor
    ...
    def estimate_training_memory_mb(
        ...
        predicted_peak_allocated_mb = (
            ...
            + self.optimizer_step_peak_buffer_mb
        )
        ...
        return {
            ...
            "optimizer_step_peak_buffer_MB": self.optimizer_step_peak_buffer_mb,
            "allocator_padding_MB": allocator_padding_mb,

            "activation_factor": self.activation_factor,
            "backward_temp_factor": self.backward_temp_factor,
